                                ...
                                <form onSubmit={(event)=>{event.preventDefault();}}>
                                    <div className="form-row">
                                        <div className="form-group col-md-12">
                                            First Name :-<input type="text" className="form-control" ref="name" id="name" placeholder="Name" class="form-control is-valid"  onchange={(e)=>this.setState({ name: e.target.value })}    />
                                        </div>
                                    </div>
                                    <div className="form-row">
                                        <div className="form-group col-md-12">
                                            Last Name :- <input type="text" className="form-control" ref="last"  id="last" placeholder="Last name" class="form-control is-valid" onchange={(e)=>this.setState({ last: e.target.value })}   />
                                        </div>
                                    </div>
                                    ...
                                    <div className="form-row">
                                        <div className="form-group col-md-12">
                                            Email <input type="email" className="form-control" ref="email" id="email" placeholder="Email" class="form-control is-valid" onchange={(e)=>this.setState({ email: e.target.value })}    />
                                        </div>
                                    </div>
                                </form>
                            </div>
                                ...
                                this.state.searchdata.map((v,i)=>{
                                    return (
                                        <tr>
                                            ...
                                            <td>{v.state}</td>
                                            <td>{v.city}</td>
                                            <td><button className="btn" onClick={()=>{this.edtInfo(v._id)}}   data-toggle="modal" data-target="#myedit">Edit</button>
                                                <button className="btn" onClick={()=> {this.setState({Deleteid: v._id})}} data-toggle="modal" data-target="#mydel">Delete</button> </td>
                                        </tr>
                                    )
                                })
                                :
